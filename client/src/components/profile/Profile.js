  ...
  return (
    <Fragment>
      {profile === null || loading ? (
        ...
        <Fragment>
          <Link to="/profiles" classNameName="btn btn-light">
            Back To Profiles
          </Link>
          {auth.isAuthenticated &&
            auth.loading === false &&
            auth.user._id === profile.user._id && (
              <Link to="/edit-profile" classNameName="btn btn-dark">
                Edit Profile
              </Link>
            )}
          <div className="profile-grid my-1">
            ...
            <div classNameName="profile-exp bg-white p-2">
              <h2 classNameName="text-primary">Experience</h2>
